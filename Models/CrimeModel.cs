...
namespace DIS_Assignment4.Models
{
    ...
    public class ColoradoRootobject
    {
        public ColoradoResult[] results { get; set; }
        public ColoradoPagination pagination { get; set; }
    }
    
    public class ColoradoPagination
    {
    ...
    public class TexasRootobject
    {
        public TexasResult[] results { get; set; }
        public TexasPagination pagination { get; set; }
    }

    public class TexasPagination
    {
        public int count { get; set; }
        public int page { get; set; }
        public int pages { get; set; }
